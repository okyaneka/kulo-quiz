...
<script setup lang="ts">
  import { getResultPreviewData } from '~/apps/results/results.repositories'
  ...
  const {
    ...
    queryKey: ['result'],
    queryFn: () => getResultPreviewData(route.params.resultId as string),
    enabled: false,
  })
    ...
    <el-col style="position: sticky; bottom: 64px; margin-top: auto">
      <el-card :body-style="{ padding: '12px' }">
        <el-row justify="space-between" align="middle">
          <router-link :to="{ name: 'p-id-review' }">
